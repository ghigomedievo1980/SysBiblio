...
<div>
	<img src="<?= $base; ?>/assets/imagens/niveis-64x64.png" alt="Níveis de Acesso" /><br />
	<h4>Cadastrar Níveis de Acesso</h4>
</div>
<a href="index.php?pag=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-primary mt-2 mb-4">Novo Nível</a>
<small>
	<table id="example" class="table table-hover table-sm my-4" style="width:98%;">
		...
		<tbody>
            ...
            ?>
            <tr>
                <td><img src="<?= $base; ?>/assets/imagens/niveis-16x16.png" /></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php 
                if(@$_GET['funcao'] == 'novo'){
                    $titulo_modal = 'Inserir Nível de Acesso';
                } else {
                    $titulo_modal = 'Editar Nível de Acesso';
                    $idnivel = @$_GET['id'];
                    $query = $PDO->query("SELECT * FROM niveis WHERE  id = '$idnivel'");
                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                    $nivel = @$res[0]['nivel'];
                }
                ?>
            ...
            <form method="post" id="form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nivel" name="nivel" placeholder="Nível" value="<?php echo @$nivel ?>" required>
                    </div>	

                    <input type="hidden" name="id"  value="<?php echo @$idnivel ?>">
...
<div class="modal fade" id="excluir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Excluir Nível</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="post" id="form-excluir">
                <div class="modal-body">
                    ...
                    <span class="mb-2">Deseja Realmente Excluir este Nível?</span>
                    <br><br>
...
<script type="text/javascript">
    $("#form").submit(function () {
        ...
        $.ajax({
            url: "<?= $base; ?>/operacao/niveis/inserir.php",
            type: 'POST',
            data: formData,
...
<script type="text/javascript">
    $("#form-excluir").submit(function () {
        ...
        $.ajax({
            url: "<?= $base; ?>/operacao/niveis/excluir.php",
            type: 'POST',
            data: formData,
