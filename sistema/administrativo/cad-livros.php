...
<small>
	<table id="example" class="table table-hover table-sm my-4" style="width:98%;">
		...
		<tbody>
			<?php 
			    $query = $PDO->query("SELECT * FROM acervo WHERE idtipopublicacao = 1 ORDER BY titulo ASC");
				    ...
				    <div class="row">
                        ...
                        <div class="col-4">
						    <div class="mb-3">
								...
								<input type="text" class="form-control" id="isbn13" name="isbn" placeholder="Ex.: 85-950-8678-8" value="<?php echo @$isbn ?>">	
							</div>
						</div>
					    ...
					    <div class="col-10">
						    <div class="mb-3">
								...
								<textarea class="form-control" id="descricao" name="descricao" rows="3" cols="8"><?php echo @$descricao ?></textarea>
						    </div>	
					    </div>			
                    </div>
					<input type="hidden" name="id"  value="<?php echo @$id ?>">
                    <input type="hidden" name="idtipopublicacao" value="1">
					<small>
	...
	<div class="modal-dialog">
	    <div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="mb-2">
				    <span><b>ISBN : </b></span><span id="isbn_registro"></span>
				</div>
                <div class="mb-2">
